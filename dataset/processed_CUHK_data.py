...
def parse_args():
    ...
    parser.add_argument('--img_root', default='../dataset/CUHK-PEDES/CUHK-PEDES/imgs', type=str)
    parser.add_argument('--json_root', default='../dataset/CUHK-PEDES/CUHK-PEDES/reid_raw.json', type=str)
    parser.add_argument('--out_root', default='../dataset/CUHK-PEDES/bert_processed_data', type=str) # processed_data_spa_img
