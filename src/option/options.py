...
class options():
    def __init__(self):
        ...
        self._par.add_argument('--epoch', type=int, default=45, help='train epoch')
        ...
        self._par.add_argument('--stride', type=bool, default=True)
        ...
        self._par.add_argument('--device', type=str, default='cuda', help='cuda devie')
        self._par.add_argument('--dataset', type=str, default='CUHK-PEDES', help='choose the dataset ')
        self._par.add_argument('--wordtype', type=str, default='bert')
        self._par.add_argument('--dataroot', type=str, default='../dataset/CUHK-PEDES', help='data root of the Data')
        self._par.add_argument('--pkl_root', type=str, default='../dataset/CUHK-PEDES/bert_processed_data/', help='data root of the Data')
